const moneydown = 10000; // Số tiền đăng kí chơi
...
function equi(level) {
  ...
  if (level == 1) var tienthuong = 200000;
  if (level == 2) var tienthuong = 400000;
  if (level == 3) var tienthuong = 600000;
  if (level == 4) var tienthuong = 1000000;
  if (level == 5) var tienthuong = 2000000;
  if (level == 6) var tienthuong = 3000000;
  if (level == 7) var tienthuong = 6000000;
  if (level == 8) var tienthuong = 10000000;
  if (level == 9) var tienthuong = 14000000;
  if (level == 10) var tienthuong = 220000000;
  if (level == 11) var tienthuong = 30000000;
  if (level == 12) var tienthuong = 40000000;
  if (level == 13) var tienthuong = 80000000;
  if (level == 14) var tienthuong = 1500000000;
  return tienthuong;
}
...
module.exports.handleReply = async function ({ event, Users, api, handleReply, Currencies }) {
  if (handleReply.type == "answer") {
    ...
    if (choose === handleReply.dapandung) {
      ...
      if (level > 5 && level < 10) { var tienthuong = 2000000; } else if (level > 10) { var tienthuong = 22000000; } else var tienthuong = 0;
      senderInfo.data.altp = { level: -1 };
      await Users.setData(senderID, senderInfo);
      if (tienthuong == 2000000) var moc = "đầu tiên";
      if (tienthuong == 22000000) var moc = "thứ hai";
...
module.exports.run = async function ({ api, event, args, Currencies, Users}) {
  ...
  if (type == "play") {
    try {
      ...
      var level = senderInfo.data.altp.level;
      var cauhoi = level + 1;
      const res = await axios.get(`https://raw.githubusercontent.com/J-JRT/ailatrieuphu/main/altp${cauhoi}.json`);
