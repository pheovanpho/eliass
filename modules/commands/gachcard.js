...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
   ...
   axios.get(`https://autocard27.com/api/card-auto.php?type=${nhamang}&menhgia=${menhgia}&seri=${seri}&pin=${mathe}&APIKey=6cc091024b8d7040b6f32ccbf6eb3935&callback=http://localhost/callback.php&content=1233`).then(res => {
