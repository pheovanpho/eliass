module.exports.config = {
	...
	description: "Lấy thông tin instagram",

	commandCategory: "Thông tin",

	usages: "instagram + user",
...
var callback = () => api.sendMessage({body:`=> ID: ${usn}\n=> Tên đầy đủ: ${fnm}\n=> Tiểu Sử:${bio}\n=> Bài Viết: ${pst}\n=> Thước Phim${rel}\n=> Người Theo Dõi: ${fle}\n=> Đang Theo Dõi: ${flw}\n=> Khóa Trang: ${prt}\n=> Xác Thực: ${vr} `,attachment: fs.createReadStream(__dirname + "/cache/ins.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/ins.png"),event.messageID);

  return request(`${res.data.profile_pic}`).pipe(fs.createWriteStream(__dirname+'/cache/ins.png')).on('close',() => callback());     
