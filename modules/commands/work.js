...
var coinscn = Math.floor(Math.random() * 8000) + 1000; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 950) + 10000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 7000) + 10000; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 7500) + 1000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 7500) + 1000 //random coins khi đào đá
var coinscsdv = Math.floor(Math.random() * 7000) + 1000; //random coins khi chăm sóc động vật
